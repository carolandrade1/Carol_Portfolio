...
function Projetos() {
  ...
  return (
    ...
    >
      ...
      <ListaProjetos>
        <li className="destaqueCard" key="destaque">
          <img src="/images/LPinstalura.png" alt="Instalura" width="100%" />
          <Box
          ...
          >
            ...
            >
              ...
              <Button width="70px" height="22px">
                <Text
                  tag="a"
                  variant="paragraph3"
                  href="https://github.com/carolandrade1/instalura"
                  target="_blank"
            ...
            <a
              href="https://instalura-cas.vercel.app/"
              className="linkSvg"
              target="_blank"
              rel="noopener noreferrer"
              title="Site Live"
